...
def crop_4_patches(image):
    ...
    return (
        image.crop((0, 0, crop_size, crop_size)),
        image.crop((0, crop_size, crop_size, 2 * crop_size)),
        image.crop((crop_size, 0, 2 * crop_size, crop_size)),
        image.crop((crop_size, crop_size, 2 * crop_size, 2 * crop_size)),
    )
